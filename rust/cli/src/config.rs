...
impl Config {
    pub fn new() -> Result<Config, Box<dyn Error>> {
        let matches = App::new("VortexParticleSimulation")
            .version("0.0")
            .author("Julien de Charentenay <julien@charentenay.me>")
            .about("Vortex particle fluid simulation")
            .arg(Arg::new("init")
                 .long("init")
                 .about("Initialise the simulation from a json case file")
                 .value_name("PATH/FILE")
                 .takes_value(true))
            .arg(Arg::new("restart")
                 .long("restart")
                 .about("Restart an existing simulation from a simulation file")
                 .value_name("PATH/FILE")
                 .takes_value(true))
            .arg(Arg::new("save")
                 .long("save")
                 .about("Save simulation results to a simulation file")
                 .value_name("PATH/FILE")
                 .takes_value(true))
            .arg(Arg::new("run")
                 .short('r')
            ...
            .arg(Arg::new("csv")
                 .long("csv")
                 .about("Output vortex particle positions and vorticity to CSV file format")
                 .value_name("DIRECTORY")
                 .takes_value(true))
            .arg(Arg::new("iteration")
                 .long("iteration")
                 .about("Nominate the number of iteration to run")
                 .takes_value(true)
                 .value_name("INTEGER")
                 .default_value("100"))
            .arg(Arg::new("time_step")
                 .long("timestep")
                 .about("Nominate the time step in seconds")
                 .takes_value(true)
                 .value_name("DURATION")
                 .default_value("0.03"))
            .get_matches();
